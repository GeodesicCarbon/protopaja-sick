#ifndef _ROS_infoscreen_arduino_messages_stepper_feedback_h
#define _ROS_infoscreen_arduino_messages_stepper_feedback_h
...
namespace infoscreen_arduino_messages
{
  ...
  class stepper_feedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "infoscreen_arduino_messages/stepper_feedback"; };
